...
const caut_type_descriptors_atom_api_t type_descriptors = {
  ...
  {
    .name = "cmd_reset",
    .hash = { 0xC8,0x84,0x88,0x44,0xEB,0xC1,0x29,0x9A,0x91,0xBF,0xC5,0xD0,0xC6,0x67,0x4E,0x58,0x0A,0x9B,0x77,0xC1 },
    .encode = (gen_encode*)encode_cmd_reset,
    .decode = (gen_decode*)decode_cmd_reset,
    .min_size = 1,
    .max_size = 1,
  },
  {
  ...
  {
    .name = "cmd",
    .hash = { 0x6F,0xA2,0x13,0x6F,0x08,0x13,0xC6,0x2F,0x69,0x88,0x70,0xBE,0x71,0x48,0x3D,0x36,0x2B,0x1E,0x45,0x4B },
  ...
  {
    .name = "txn",
    .hash = { 0x82,0x9F,0x58,0xD4,0x2E,0xA8,0x7E,0xF9,0x85,0x58,0x0C,0x79,0x68,0xAC,0x8F,0xBD,0x7F,0x99,0x3D,0x90 },
...
R encode_message_atom_api(EI * const _iter, struct message_atom_api const * const _obj) {
  ...
  _data_len = (unsigned char)(_iter->position - _data_position);
